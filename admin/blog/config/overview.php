...
// Konfiguration laden
$Config = array();
$Module->initConfigOverview($Config);
// Konfiguration speichern
if (isset($_GET['save'])) $Module->saveConfigOverview($Config);
...
$out .= '
<form name="contentIndex" method="post" action="overview.php?id='.page::menuID().'&save">
...
<table width="100%" cellpadding="3" cellspacing="0" border="0">
	<tr>
		<td colspan="2">
			<h1>'.$Res->html(655,page::language()).'</h1><br>
		</td>
	</tr>
	<tr>
		<td width="150">
