...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td class="cNavSelected" width="140">'.$Res->html(509,page::language()).'</td>
	...
	<tr>
		<td class="cToolbar">
			...
			<div class="cToolbarItem">
				...
				<img src="/images/icons/world_add.png" alt="'.$Res->html(508,page::language()).'" title="'.$Res->html(508,page::language()).'" border="0">
				</a>
			</div>
			<div class="cToolbarItem">
				<img src="/images/icons/toolbar-line.gif" alt="|">
...
<table cellpadding="3" cellspacing="0" border="0">
	<tr>
		<td colspan="5">
			<h1>'.$Res->html(509,page::language()).'</h1><br>
		</td>
	</tr>
</table>
	<div class="tabRowHead" style="width:100%;height:20px;padding-top:5px;">
		...
		<div style="width:190px;float:left"><strong>'.$Res->html(652, page::language()).'</strong></div>
...
foreach ($Data as $row) {
	...
	<div class="'.$TabRow->get().'" name="tabRow[]" style="width:100%;height:25px;padding-top:5px;">
		...
		<div style="width:190px;float:left">
			'.$Module->getLinkCategory($row,$Categories).'
		</div>
