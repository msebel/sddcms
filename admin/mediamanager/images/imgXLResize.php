...
if (isset($_POST['cmdResize'])) {
	...
	mediaLib::updateElementData($Conn,$Res,$mediaInstance,'images/imgXLResize.php');
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td class="cNav" width="150"><a href="imgResize.php?id='.page::menuID().'&file='.fileLib::getNonXLVersion($mediaInstance->Progress).'">'.$Res->html(277,page::language()).'</td>
		<td class="cNavSelected" width="150">'.$Res->html(201,page::language()).'</td>
		<td class="cNav" width="150"><a href="imgInfo.php?id='.page::menuID().'&file='.fileLib::getNonXLVersion($mediaInstance->Progress).'">'.$Res->html(278,page::language()).'</a></td>
		<td class="cNav">&nbsp;</td>
	</tr>
</table>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
...
$out .= '
<form name="pictureForm" method="post" action="imgXLResize.php?id='.page::menuID().'">
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
	...
	<tr>
		<td>
			...
			<input type="hidden" name="keepOriginal" value="0">
		</td>
	</tr>
</table>
<br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td>
			<h1>'.$Res->html(276,page::language()).' - '.fileLib::getNonXLVersion($mediaInstance->Progress).'</h1>
			<br>
		</td>
	</tr>
	<tr>
