...
if (isset($_POST['cmdSave'])) {
	...
	mediaLib::updateElementData($Conn,$Res,$mediaInstance,'flash/flvEdit.php');
}

// Standardgrösse holen, wenn nicht vorhanden
if (getInt($mediaInstance->getProperty('width')) <= 0) {
	$mediaInstance->setProperty('width',400);
}
if (getInt($mediaInstance->getProperty('height')) <= 0) {
	$mediaInstance->setProperty('height',300);
}
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td class="cNavSelected" width="150">'.$Res->html(298,page::language()).'</td>
		<td class="cNav" width="150"><a href="flvSkin.php?id='.page::menuID().'">'.$Res->html(299,page::language()).'</a></td>
		<td class="cNav">&nbsp;</td>
	</tr>
</table>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
...
$out .= '
<form name="flvForm" method="post" action="flvEdit.php?id='.page::menuID().'">
<input type="hidden" name="cmdSave" value="1">
<table width="100%" border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td colspan="2">
			<h1>'.$Res->html(300,page::language()).'</h1><br>
		</td>
	</tr>
	<tr>
		<td width="150" valign="top">
			'.$Res->html(301,page::language()).':
		</td>
		<td valign="top">
