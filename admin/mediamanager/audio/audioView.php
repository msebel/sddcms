...
if (strlen($mediaInstance->getProperty('width')) == 0) {
	$mediaInstance->setProperty('width',200);
}
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td class="cNavSelected" width="200">'.$Res->html(309,page::language()).'</td>
		<td class="cNav">&nbsp;</td>
	</tr>
</table>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
...
// Titel anzeigen
$out .= '
<h1>'.$Res->html(309,page::language()).' - '.$mediaInstance->Progress.'</h1>
<br>
<br>
';
// Flash Code erzeugen
