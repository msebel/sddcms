...
$Config = array();
$Module->initConfigBlogStats($nTapID,$Config);

// Speichern von Daten, zuvor zugriff checken
$Module->checkAccess();
if (isset($_GET['save'])) $Module->saveConfigBlogStats($nTapID,$Config);

// Toolbar erstellen
$out = '
<form name="contentEdit" method="post" action="blogStats.php?id='.page::menuID().'&element='.$nTapID.'&save">
...
<table width="100%" cellspacing="0" border="0" cellpadding="3">
	<tr>
		<td colspan="2"><h1>'.$Res->html(665,page::language()).'</h1><br>
