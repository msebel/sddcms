...
$Config = array();
$Module->initConfigCategoryList($nTapID,$Config);

// Speichern von Daten, zuvor zugriff checken
$Module->checkAccess();
if (isset($_GET['save'])) $Module->saveConfigCategoryList($nTapID,$Config);

// Toolbar erstellen
$out = '
<form name="contentEdit" method="post" action="categoryList.php?id='.page::menuID().'&element='.$nTapID.'&save">
...
<table width="100%" cellspacing="0" border="0" cellpadding="3">
	<tr>
		<td colspan="2"><h1>'.$Res->html(664,page::language()).'</h1><br>
