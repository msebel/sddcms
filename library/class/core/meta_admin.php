...
cacheLib::checkDesignFiles(page::admindesign(true));
// System CSS und Javascripts einbinden
$version = getInt(option::get('designCssVersion_'.page::admindesign(true),1));
$Meta->addCSS(singleton::cdn().'/resource/css/design.php?p[d]='.page::admindesign(true).'&v'.$version);
...
$Meta->addMeta('revisit-after','60 days');
